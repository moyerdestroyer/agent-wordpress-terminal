    ...
    private function help(): array {
        return [
            'content' => implode("\n", [
                ...
                __(
                    '/plan [notes] - evaluate focused page only (read tools; no staging). Then use Execute plan in the terminal.',
                    'agent-wordpress-terminal',
                ),
                __('/evaluate [notes] - same as /plan', 'agent-wordpress-terminal'),
                __(
                    '/improve [notes] - plan then stage in one go (or use Improve). Apply the staged proposal to write the page.',
                    'agent-wordpress-terminal',
                ),
